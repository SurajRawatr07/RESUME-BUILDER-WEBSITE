...
export default function AuthPage({
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-center items-center px-4 py-8 sm:px-6 lg:px-8 bg-transparent text-slate-900 dark:text-gray-100 transition-colors duration-200 relative">

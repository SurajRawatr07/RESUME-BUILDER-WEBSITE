    ...
    >
      <div
        className={cn(
          ...
          isExpanded
            ? 'bg-white dark:bg-[#171717] border border-black/[0.12] dark:border-white/[0.15] shadow-sm'
            : 'bg-white dark:bg-[#171717] border border-black/[0.08] dark:border-white/[0.09] hover:border-black/[0.12] dark:hover:border-white/[0.14] shadow-2xs',
          className
        )}
      >
        {/* ─── Glowing Shadow Layer (Active item receives subtle neutral treatment) ─── */}
        <div
          aria-hidden="true"
          className={cn(
            ...
            isExpanded
              ...
              : 'opacity-0 group-hover:opacity-25 dark:group-hover:opacity-30'
          )}
        >
          <div className="absolute inset-0 overflow-hidden rounded-2xl">
            <div className="absolute -inset-[50%] w-[200%] h-[200%] m-auto glowing-static-bg" />
          </div>
        </div>

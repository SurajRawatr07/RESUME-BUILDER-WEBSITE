...
export default function OpenSourceTemplate({ data }: TemplateProps) {
  ...
  return (
    ...
    >
      {/* 1. OPEN SOURCE MAINTAINER HEADER */}
        ...
        <div className="flex flex-col sm:flex-row justify-between items-baseline gap-1">
          <div>
            ...
            <p className="text-[10pt] font-bold text-gray-800 tracking-wide">
              {data.jobTitle || 'Open Source Software Engineer & Maintainer'}
            </p>
          </div>
          <div className="text-[8.5pt] text-gray-800 flex flex-col items-start sm:items-end gap-0.5">
            <div className="flex items-center gap-2">
              ...
              {data.github && (data.portfolio || data.website) && <span>•</span>}
      ...
      {/* 2. OPEN SOURCE HIGHLIGHTS & SUMMARY */}
      ...
      {/* 3. OPEN SOURCE PROJECTS & LIBRARIES (Top Section for OSS) */}
      {data.projects && data.projects.length > 0 && (
        <section className="mb-2.5">
          <h2 className="text-[10pt] font-bold tracking-widest uppercase border-b border-black pb-0.5 mb-1.5 text-black flex items-center justify-between">
            <span>Open Source Projects & Packages</span>
            <span className="text-[7.5pt] font-normal tracking-normal text-gray-600">NPM • GitHub • Crates</span>
          </h2>
      ...
      <section className="mb-2">
        ...
        <div className="space-y-0.5 text-[9pt] leading-snug">
          <div>
            ...
            <span className="text-gray-900">{cat.languages.join(', ') || 'TypeScript, JavaScript, Rust, Go, Python'}</span>
          </div>
          <div>
            <span className="font-bold text-black">Tooling & Build Systems: </span>
            <span className="text-gray-900">{cat.tools.join(', ') || 'Git, GitHub Actions, Vite, Turborepo, Rollup, Docker'}</span>
          </div>
          <div>
            <span className="font-bold text-black">Testing & Frameworks: </span>
